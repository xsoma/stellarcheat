...
void render::init() {
	...
	esp = Font(XOR("Verdana"), 12, FW_NORMAL, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW); // skeet name font, pandora font Font(XOR("Segoe UI"), 14, FW_NORMAL, FONTFLAG_ANTIALIAS);
	esp_grenade = Font(XOR("Segoe UI"), 18, FW_NORMAL, FONTFLAG_ANTIALIAS);
	esp_small = Font(XOR("Small Fonts"), 8, FW_NORMAL, FONTFLAG_OUTLINE); // weapon string font
	esp_info = Font(XOR("Smallest Pixel-7"), 10, FW_NORMAL, FONTFLAG_OUTLINE); // drop weapons
	...
	esp_name = Font(XOR("Verdana"), 12, FW_BOLD, FONTFLAG_DROPSHADOW);
	manual = Font( XOR( "Acta Symbols W95 Arrows" ), 24, FW_MEDIUM, FONTFLAG_ANTIALIAS );
	...
	g_csgo.m_surface->SetFontGlyphSet(F::Icons = g_csgo.m_surface->CreateFont(), XOR("Counter-Strike"), 13, FW_NORMAL, NULL, NULL, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
