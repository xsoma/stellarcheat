...
public:
	void init() {
		...
		minimal_damage.setup( XOR( "minimal damage" ), XOR( "minimal_damage" ), 1.f, 101.f, true, 0, 4.f, 1.f );
		RegisterElement( &minimal_damage );

		penetrate.setup( XOR( "penetrate walls" ), XOR( "penetrate" ) );
		RegisterElement( &penetrate );

		penetrate_minimal_damage.setup( "", XOR( "penetrate_minimal_damage" ), 1.f, 101.f, false, 0, 3.f, 1.f );
		...
		debugaim_color.setup(XOR("debug aimbot color"), XOR("debug_aimbot_color"), { 255, 0, 0, 200 });
...
public:
	void init() {
		...
		// chams selection.
		chams_selection.setup( XOR( "chams options" ), XOR( "chams_selection" ), { XOR( "enemy" ), XOR( "friendly" ), XOR( "local" ), XOR( "fake yaw" ) } );
		...
		chams_enemy_mat.setup( XOR( "chams enemy material" ), XOR( "chams_enemy_mat" ), { XOR( "default" ), XOR( "flat" ), XOR( "metallic" ), XOR( "outline" ), XOR( "ghost" ) } );
		...
		chams_enemy_history_mat.setup( XOR( "chams history material" ), XOR( "chams_enemy_history_mat" ), { XOR( "default" ), XOR( "flat" ), XOR( "metallic" ), XOR( "outline" ), XOR( "ghost" ) } );
		...
		chams_enemy_history_wireframe.setup( XOR( "wireframe" ), XOR( "chams_enemy_history_wireframe" ) );
		chams_enemy_history_wireframe.AddShowCallback( callbacks::IsEnemyChams );
		RegisterElement( &chams_enemy_history_wireframe, 1 );
		...
		chams_friendly_mat.setup( XOR( "chams friendly material" ), XOR( "chams_friendly_mat" ), { XOR( "default" ), XOR( "flat" ), XOR( "metallic" ), XOR( "outline" ), XOR( "ghost" ) } );
		...
		chams_local_mat.setup( XOR( "chams local material" ), XOR( "chams_local_mat" ), { XOR( "default" ), XOR( "flat" ), XOR( "metallic" ), XOR( "outline" ), XOR( "ghost" ) } );
...
public:
	void init() {
		...
		RegisterElement(&removes, 1);

		no_scope_type.setup(XOR("no scope type"), XOR("no_scope_type"), { XOR("default"), XOR("skeet") });
		RegisterElement(&no_scope_type, 1);

		scope_color.setup( XOR( "scope color" ), XOR( "scope_color" ), colors::red );
		RegisterElement( &scope_color, 1 );
		...
		indicators.setup(XOR("indicators"), XOR("indicators"), { XOR("lby"), XOR("lag compensation"), XOR("fake latency"), XOR("override damage"),  XOR("lag walk"), XOR("keybinds") });
		...
		impact_beams_time.setup(XOR("impact beams scale"), XOR("impact_beams_scale"), 1.f, 20.f, true, 0, 1.f, 1.f, XOR(L"s"));
		RegisterElement(&impact_beams_time, 1);

		beam_type.setup(XOR("impact beam type"), XOR("impact_beams_type_phys"), { XOR("supremacy"), XOR("skeet") });
		RegisterElement(&beam_type, 1);
...
public:
	...
	void init() {
		...
		offscreen_mode.setup(XOR("offscreen size"), XOR("offscreen_mode"), 20.f, 200.f, true, 0, 165.f, 1.f, XOR(L""));
